...
function handleInfiniteScroll(){let startLoading=function(){playlistLoader.style.display='block';playlistScroll.dataset.processing='1';},stopLoading=function(){playlistLoader.style.display='none';playlistScroll.dataset.processing='';},createListItem=function(item){let div=document.createElement('div');div.innerHTML='<li class="playlist__item" data-episode="'+item.episode_id+'">'+
